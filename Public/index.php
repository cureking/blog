		...
		<div class="container">
			<div class="row w_main_row">
						...
						<div id="w_carousel" class="carousel slide w_carousel" data-ride="carousel">
							...
							<div class="carousel-inner" role="listbox">
								<div class="item active">
									<img src="./imgs/slider/slide1.jpg" alt="...">
								...
								<div class="item">
									<img src="./imgs/slider/slide2.jpg" alt="...">
									<div class="carousel-caption">...</div>
								</div>
								<div class="item">
									<img src="./imgs/slider/slide3.jpg" alt="...">
									<div class="carousel-caption">...</div>
								</div>
								<div class="item">
									<img src="./imgs/slider/slide4.jpg" alt="...">
									<div class="carousel-caption">...</div>
								</div>
							</div>
										...
										<div class="contentImage">
											<div class="row">
												<a href="#" class="thumbnail w_thumbnail">
													<img src="./imgs/slider/Aj6bieY.jpg" alt="...">
												</a>
											</div>
										</div>
									</div>
								...
								<div class="panel panel-default">
									<div class="panel-body">
										...
										<div class="contentImage">
											...
											<div class="row">
												<a href="#" class="thumbnail w_thumbnail">
													<img src="./imgs/slider/abs_img_no.jpg" alt="...">
												</a>
											</div>
										</div>
									</div>
								...
								<div class="panel panel-default">
									<div class="panel-body">
										...
										<div class="contentImage">
											...
											<div class="row">
												<a href="#" class="thumbnail w_thumbnail">
													<img src="./imgs/slider/67zmaej.png" alt="...">
												</a>
											</div>
										</div>
									</div>
				...
				<div class="col-lg-3 col-md-3 w_main_right">
					...
					<!--站点公告-->
                    <?php include('./sidebar/Site-Bulletin.html'); ?>

					<!--热门标签-->
                    <?php include('./sidebar/hot-tag.php'); ?>

					<!--热门发布-->
                    <?php include('./sidebar/hot-post.php'); ?>

					<!--友情链接-->
                    <?php include('./sidebar/friendly-link.html'); ?>

					<!--微信公众号-->
                    <?php require('./sidebar/official-account.html'); ?>
